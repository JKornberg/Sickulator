...
from sickulator.settings import building_addresses, home_addresses, social_building_ids, work_building_ids, food_building_ids
...
class dummy_agent:
    def __init__(self):
        self.preferences = (y:=np.random.rand(3))/y.sum() * DAY_LENGTH
